...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 27 jan. 2025 à 09:47
...
(66, 35, 'Service du Suivi-Evaluation du Secteur public et du Reporting', '009'),
(67, 29, 'Service des Accidents de Travail et des Maladies Professionnelles', '201'),
(68, 39, 'Service de l’Evaluation de la Performance des Agents de l’Etat', '202'),
(69, 29, 'Service du Personnel Encadré', '117'),
(70, 29, 'Service de la Gestion administrative du Recrutement', '207'),
(71, 28, 'Service de la Logistique et de la Gestion du Patrimoine', '210'),
(72, 30, 'Service Financier', '213'),
(73, 29, 'Service du Personnel non Encadré', '214'),
(74, 28, 'Service de la Maintenance et de l’’entretien des infrastructures Ministère ', '218'),
(75, 29, 'Service de circuit des dossiers à la Direction des Ressources Humaines de l’Etat', '220'),
(76, 40, 'Service secrétariat', '222'),
(77, 41, 'Service des Affaires disciplinaires', '104'),
(78, 42, 'Service des Equivalences Administratives des titres', '107'),
(79, 21, 'Service de la Modernisation de la Fonction Publique', '115'),
(80, 21, 'Service de la Gestion Prévisionnelle des Effectifs de l’Emploi et des Compétences', '115'),
(81, 29, 'Service de Recensement et de Redéploiement', '116'),
(82, 40, 'Service des Organigrammes et de la Documentation ', '118'),
(83, 40, 'Service d’Appui aux Etudes Juridiques', '119'),
(84, 40, 'Service de la Législation et Contentieux', '120'),
(85, 40, 'Service des Organigrammes et de la Documentation', '121'),
(86, 42, 'Service d’Appui et Contrôle des Etablissements de Formation publique et privée', '122'),
(87, 42, 'Service des Concours Administratifs', '123');
...
--
ALTER TABLE `service`
  MODIFY `id_s` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;

--
-- AUTO_INCREMENT pour la table `serviceoffert`
--
ALTER TABLE `serviceoffert`
  MODIFY `id_service` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
