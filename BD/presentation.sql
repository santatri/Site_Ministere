...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 28 jan. 2025 à 21:09
...
(88, 44, 'Service de la Main d’œuvre à l’étrange', '405');
...
--
ALTER TABLE `service`
  MODIFY `id_s` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;

--
-- AUTO_INCREMENT pour la table `serviceoffert`
--
ALTER TABLE `serviceoffert`
  MODIFY `id_service` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
