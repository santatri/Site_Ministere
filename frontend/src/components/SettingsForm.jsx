    ...
    {isEditing ? (
      <>
        ...
        <td>
          ...
          {settings.logo && <img src={`${API_URL}/uploads/${settings.logo}`} alt="Logo actuel" width="50" />}
        </td>
        <td>
          <input type="file" name="logoDG" onChange={handleFileChange} />
          {settings.logoDG && <img src={`${API_URL}/uploads/${settings.logoDG}`} alt="LogoDG actuel" width="50" />}
        </td>
        <td>
