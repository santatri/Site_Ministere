...
import derheImage from '../assets/madame.jpg'; // Remplacez par l'image appropriée
import '../styles/DerhePage.css';
  ...
  return ( 
    ...
    <div className="containeres">
      ...
      <div className="images-containeres">
        {/* Image à gauche */}
        <img src={derheImage} alt="DGFOP" className="image-framees" />
